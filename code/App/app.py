...
app.layout = html.Div(
    ...
    children=[
        html.H1('Car Price Prediction', style={
            ...
            'color': '#000000',
            'margin-bottom': '30px'}),
        html.P('Instructions: Please enter the values for Engine, Mileage, and Year in the respective fields. '
               'The prediction model will use these inputs to estimate the car price. '
               'Click "Submit" to view the predicted price.',
               style={
                   'font-size': '14px',
                   'color': '#555',
                   'margin-bottom': '30px',
